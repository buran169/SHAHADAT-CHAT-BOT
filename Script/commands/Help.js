...
`;
 ...
 return request("https://imgur.com/a/ZD1lesQ").pipe(fs.createWriteStream(imgPath)).on("close", () => callback());
 }
 ...
 return request("https://imgur.com/a/YD3ejJH").pipe(fs.createWriteStream(imgPath)).on("close", () => callback());
};
